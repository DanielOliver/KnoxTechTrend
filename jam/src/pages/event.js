    ...
    render() {
        ...
        return (
            <Table>
                ...
                <TableBody>
                    {this.props.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(x => {
                        const row = x.node;
                        return (
                            <TableRow key={row.id}>
                                <TableCell component="th" scope="row">
                                    <Link to={row.trendURL}>{row.Name}</Link>
                                </TableCell>
...
const EventList = () => (
    ...
    `}
        render={data => (<EventTable rows={data.events.edges} />)}
    />
)
